...
function initTutorial() {
    ...
    // Create an invisible blocker to prevent scrolling and clicking on anything else
    ...
    // Globally prevent touch scrolling and mouse wheel scrolling during tutorial
    ...
    function showStep(index) {
        ...
        // Scroll to element if it's not a fixed modal
        ...
        if (typeof i18nTranslations !== 'undefined' && i18nTranslations[lang] && i18nTranslations[lang][step.textI18n]) {
            infoText.innerText = i18nTranslations[lang][step.textI18n];
        } else {
            infoText.innerText = step.textI18n;
        }
        
        if (typeof i18nTranslations !== 'undefined' && i18nTranslations[lang]) {
    ...
    function endTutorial() {
        ...
        // Scroll back to the landing page
    ...
    nextBtn.addEventListener('click', () => {
        ...
        // Hide UI immediately during transition
        const hole = document.getElementById('tutHole');
        if (hole) hole.style.display = 'none';
        infoBox.style.display = 'none';
    ...
    // Start tutorial at the very top of landing page
