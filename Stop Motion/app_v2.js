...
function initAllCardsAll() {
    ...
    // Collect all design cards from 2026 and 2025 (prioritize 2026)
    [...allCards2026, ...allCards2025].forEach(card => {
        const img = card.querySelector('img');
        const src = img ? decodeURIComponent(img.src) : '';
    ...
    // Shuffle removed. Order will be based on extraction order.
