...
|    +-------------------------+    |
|                                   |
|           Anak kepada             |  <-- Nama Ibu Bapa
|       En. Roslan bin Hasan        |
|      & Pn. Aminah binti Yusuf     |
|                                   |
|  Majlis Perkahwinan               |
|  Sabtu, 24 Oktober 2026           |  <-- Tarikh & Masa
|  11:00 AM - 4:00 PM               |
...
|  [■] Hijau [■] Emas [■] Putih     |
|                                   |
|  [ 00 Hari | 00 Jam | 00 Minit ]  |  <-- Countdown Timer
|                                   |
|  [  Buka Waze / Google ]        |  <-- Butang Navigasi (Papar Modal)
